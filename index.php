...
<head>
    ...
    <title>Big Library - the ancient way of reading</title>
</head>
<body>
    <!-- Navbar -->
    <nav class="navbar navbar-index navbar-expand-lg navbar-dark bg-light p-5" id="navindex">
  <div class="container-fluid">
  <a class="navbar-brand d-flex align-items-center nav-logo me-5" href="index.php">
            <img src="img/book-logo.png" alt="" width="100" height="100" class="d-inline-block align-text-top nav-logo-img">
            Big Library</a>
    ...
    <div class="hero">
        ...
        <div class="hero-container d-flex justify-content-center">
            ...
            <h2 class="hero-headline">Welcome</h2>
            <h2 class="hero-headline2">to Big Library</h2>
            <div class="hero-text mt-4">Explore the finest selection of books</div>
        </div>
        </div>
